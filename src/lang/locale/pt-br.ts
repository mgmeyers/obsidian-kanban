...
export default {    
  ...
  "When toggled, dates will be hidden card titles. This will prevent dates from being included in the title when creating new notes.": "Ao ativar, as datas serão títulos de cartões ocultos. Evita que datas sejam incluídas no título ao criar novas notas.",
  ...
  "When toggled, the current date and time will be added to the beginning of a card when it is archived. Eg. - [ ] 2021-05-14 10:00am My card title": "Quando ativada, a data e a hora atuais serão adicionadas ao início de um cartão quando ele for arquivado. Ex.: - [] 2021-05-14 10:00 Título do meu cartão",
  ...
  "When toggled, tags will be hidden card titles. This will prevent tags from being included in the title when creating new notes.": "Quando ativada, as ‘tags’ não serão exibidas nos títulos de cartas. Isso impedirá que as ‘tags’ sejam incluídas no título ao criar novas notas.",
  "Hide card display tags": "Ocultar ‘tags’ de exibição de cartão",
  "When toggled, tags will not be displayed below the card title.": "Quando ativada, as ‘tags’ não serão exibidas abaixo do título do cartão.",
  "Linked Page Metadata": "Metadados de páginas 'lincadas'",
  "Display metadata for the first note linked within a card. Specify which metadata keys to display below. An optional label can be provided, and labels can be hidden altogether.": "Exibe metadados para a primeira nota 'lincada' em um cartão. Especifique abaixo quais metadados serão exibidos. Um rótulo opcional pode ser fornecido e os rótulos podem ser ocultados completamente.",
